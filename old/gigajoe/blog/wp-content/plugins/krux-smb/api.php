<?php
// Only uncomment the following if you have PhpConsole.php in your path
// and you need to debug in the Chrome console.
...
class WPKruxApi{
	...
	function changeAccount ( ) {
		if( isset($_POST["confid"]) &&
			...
			update_option("kx_confid", $_POST["confid"]);
			update_option("kx_organization_name", $_POST["organization_name"]);
			update_option("kx_site_name", $_POST["site_name"]);
		}
	}
