...
casper.then(function(){
	casper.test.assertExists('#toplevel_page_krux_smb a.toplevel_page_krux_smb', 'logged in and plugin is installed');
});

casper.then(function(){
	casper.evaluate(function(){
		document.querySelector('#toplevel_page_krux_smb a.toplevel_page_krux_smb').click();
	});
});

casper.thenOpen(base + '/wp-admin/admin.php?page=krux_smb#social', function() {
