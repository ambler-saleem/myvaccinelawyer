...
class MkdInstagramApi {
    ...
    private $apiURL;
    /**
     * @var MkdInstagramApi instance of current class
     */
    private static $instance;

    /**
     * Helper object
     * @var MkdInstagramHelper
     */
    private $helper;
    ...
    private function __construct() {
        ...
        $this->helper = new MkdInstagramHelper();
    }
     ...
     * @return string
     *
     * @see MkdInstagramApi::buildCurrentPageURI()
     */
     ...
     * @return stdClass
     *
     * @see MkdInstagramApi::getAccessToken()
     */
