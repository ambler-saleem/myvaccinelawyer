	...
	<div class = "mkd-portfolio-filter-holder-inner">
		...
		<ul>
			<?php if($type == 'masonry' || $type == 'pinterest'){ ?>
				<li class="filter" data-filter="*"><span><?php  print __('All', 'mikado_core')?></span></li>
			<?php } else{ ?>
				<li data-class="filter_<?php print $rand_number ?>" class="filter_<?php print $rand_number ?>" data-filter="all"><span><?php  print __('All', 'mikado_core')?></span></li>
			<?php } ?>
