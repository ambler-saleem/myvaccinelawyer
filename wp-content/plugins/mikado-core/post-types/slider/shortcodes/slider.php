...
namespace MkdCore\CPT\Slider\Shortcodes;

use MkdCore\Lib;

/**
 * Class Slider
 * @package MkdCore\CPT\Slider\Shortcodes
 */
class Slider implements Lib\ShortcodeInterface {
    ...
    public function render($atts, $content = null) {
        ...
        if ($slider != "") {
            ...
            if ($slider_parallax == 'no' || (isset($libero_mikado_options['paspartu']) && $libero_mikado_options['paspartu'] == 'yes' && ((isset($libero_mikado_options['paspartu_on_top']) && $libero_mikado_options['paspartu_on_top'] == 'yes') || (isset($libero_mikado_options['paspartu_on_bottom_slider']) && $libero_mikado_options['paspartu_on_bottom_slider'] == 'yes')))) {
            ...
            if (isset($slider_meta['slider_thumbs'])) {
                if(isset($libero_mikado_options['vertical_area']) && $libero_mikado_options['vertical_area'] =='no' && isset($libero_mikado_options['paspartu']) && $libero_mikado_options['paspartu'] == 'no') {
            ...
            if (isset($libero_mikado_options['header_background_transparency_initial']) && $libero_mikado_options['header_background_transparency_initial'] != "1" && $libero_mikado_options['header_background_transparency_initial'] != "") {
            ...
            if (isset($libero_mikado_options['navigation_button_height']) && $libero_mikado_options['navigation_button_height'] != '') {
                $arrow_button_height = esc_attr($libero_mikado_options['navigation_button_height']);
            }

            if (!empty($libero_mikado_options['header_height'])) {
                $header_height = esc_attr($libero_mikado_options['header_height']);
            } else {
                $header_height = 90;
            }
            if ($libero_mikado_options['header_bottom_appearance'] == 'stick menu_bottom') {
                $menu_bottom = '46';
            ...
            $header_top = 0;
            if (isset($libero_mikado_options['header_top_area']) && $libero_mikado_options['header_top_area'] == "yes"){
                if(isset($libero_mikado_options['header_top_height']) && $libero_mikado_options['header_top_height'] !== ""){
                    $header_top = $libero_mikado_options['header_top_height'];
                } else {
                    $header_top = 36;
                }
            }
            ...
            if (isset($libero_mikado_options['enable_header_top_border']) && $libero_mikado_options['enable_header_top_border'] == 'yes' && isset($libero_mikado_options['header_top_border_width']) && $libero_mikado_options['header_top_border_width'] !== '') {
                $header_top_border = esc_attr($libero_mikado_options['header_top_border_width']);
            }
            if (isset($libero_mikado_options['enable_header_bottom_border']) && $libero_mikado_options['enable_header_bottom_border'] == 'yes' && isset($libero_mikado_options['header_bottom_border_width']) && $libero_mikado_options['header_bottom_border_width'] !== '') {
                $header_bottom_border = esc_attr($libero_mikado_options['header_bottom_border_width']);
            }

            $large_menu_item_border = 0;
            if (isset($libero_mikado_options['enable_manu_item_border']) && $libero_mikado_options['enable_manu_item_border'] == 'yes' && isset($libero_mikado_options['menu_item_style']) && $libero_mikado_options['menu_item_style'] == 'large_item') {
                if (isset($libero_mikado_options['menu_item_border_style']) && $libero_mikado_options['menu_item_border_style'] == 'all_borders') {
                    $large_menu_item_border = esc_attr($libero_mikado_options['menu_item_border_width']) * 2;
                }
                if (isset($libero_mikado_options['menu_item_border_style']) && $libero_mikado_options['menu_item_border_style'] == 'top_bottom_borders') {
                    $large_menu_item_border = esc_attr($libero_mikado_options['menu_item_border_width']) * 2;
                }
                if (isset($libero_mikado_options['menu_item_border_style']) && $libero_mikado_options['menu_item_border_style'] == 'bottom_border') {
                    $large_menu_item_border = esc_attr($libero_mikado_options['menu_item_border_width']);
                }
            }

            $header_height = $header_height + $header_top_border + $header_bottom_border + $large_menu_item_border;

            if (isset($libero_mikado_options['header_bottom_appearance'])) {
                switch ($libero_mikado_options['header_bottom_appearance']) {
                    case 'stick':
                        $logo_height = esc_attr($libero_mikado_options['logo_height']) / 2;
                        break;
                    ...
                    case 'fixed_hiding':
                        ...
                        break;
                    case 'regular':
                    	if (isset($libero_mikado_options['center_logo_image']) && $libero_mikado_options['center_logo_image'] == "yes"){
                        	$logo_height = esc_attr($libero_mikado_options['logo_height']) / 2;
                    	}
                    	else {
                        	$logo_height = esc_attr($libero_mikado_options['logo_height']);
                    	}
                    	break;
                    default:
                        $logo_height = esc_attr($libero_mikado_options['logo_height']);
            ...
            if ((get_post_meta($page_id, "mkd_header_color_transparency_per_page", true) !== "0") && ($libero_mikado_options['header_background_transparency_initial'] !== "0") && ((isset($libero_mikado_options['paspartu']) && $libero_mikado_options['paspartu'] == 'no') || (isset($libero_mikado_options['paspartu_on_top']) && $libero_mikado_options['paspartu_on_top'] == 'no')) && !$hide_sticky_header) {

                $header_height_padding = $header_height + $menu_bottom + $header_top;
                if ((isset($libero_mikado_options['center_logo_image']) && $libero_mikado_options['center_logo_image'] == "yes" && $libero_mikado_options['header_bottom_appearance'] !== 'stick menu_bottom' && $libero_mikado_options['header_bottom_appearance'] !== 'stick_with_left_right_menu') || $libero_mikado_options['header_bottom_appearance'] == "fixed_hiding") {
            ...
            $custom_cursor = "";
            if(isset($libero_mikado_options['qs_enable_navigation_custom_cursor']) && ($libero_mikado_options['qs_enable_navigation_custom_cursor']=="yes")){
                $custom_cursor = "has_custom_cursor";
            }

            if((isset($libero_mikado_options['paspartu']) && $libero_mikado_options['paspartu'] == 'yes' && ((isset($libero_mikado_options['paspartu_on_top']) && $libero_mikado_options['paspartu_on_top'] == 'yes') || (isset($libero_mikado_options['paspartu_on_bottom_slider']) && $libero_mikado_options['paspartu_on_bottom_slider'] == 'yes'))) || $slider_parallax == "no"){
            ...
            $ajax_loader = '';
            if($libero_mikado_options['loading_animation'] == "on") {
                if($libero_mikado_options['loading_image'] != "") {
                    $ajax_loader = '<div class="ajax_loader" ' . $loader_margin_top . '><div class="ajax_loader_1"><div class="ajax_loader_2"><img src="' . esc_url($libero_mikado_options['loading_image']) . '" alt="" /></div></div></div>';
                }else{
                    $ajax_loader = '<div class="ajax_loader" ' . $loader_margin_top . '><div class="ajax_loader_1">' . libero_mikado_loading_spinners(true) . '</div></div>';
                }
            }

            $html .= '<div id="mkd-' . esc_attr($slider) . '" ' . $anchor_data . ' ' . $responsiveness_data . ' ' . $responsive_coefficients_graphic_data . ' ' . $responsive_coefficients_title_data . ' ' . $responsive_coefficients_subtitle_data . ' ' . $responsive_coefficients_text_data . ' ' . $responsive_coefficients_button_data . ' class="carousel slide ' . esc_attr($animation_type_class . ' ' . $custom_cursor . ' ' . $full_screen_class . ' ' . $responsive_height_class . ' ' . $height_class . ' ' . $auto_start_class . ' ' . $header_effect_class . ' ' . $slider_numbers_class .  ' ' . $slider_thumbs_class . ' ' . $slider_transparency_class . ' ' . $navigation_position_class . ' ' . $content_next_to_arrows_class) . '" ' . $slide_animation . ' ' . $data_height . ' ' . $data_parallax_effect . ' '.libero_mikado_get_inline_style($slide_holder_height. $background_color).'><div class="mkd_slider_preloader" '.libero_mikado_get_inline_style($background_color).'>'.$ajax_loader.'</div>';
            $html .= '<div class="carousel-inner ' . esc_attr($slider_css_position_class) . '" '.libero_mikado_get_inline_style($carouselinner_height).' '.$data_parallax_transform.'>';
            query_posts($args);
            ...
            if (have_posts()) : $postCount = 0;
                while (have_posts()) : the_post();
                    ...
                    $thumbnail_attributes = libero_mikado_get_attachment_meta_from_url($thumbnail, array('width','height'));
                    ...
                    $svg_link = "";
                    if (get_post_meta(get_the_ID(), "mkd_slide-svg-link", true) != "") {
                        $svg_link = esc_url(get_post_meta(get_the_ID(), "mkd_slide-svg-link", true));
                    }
					...
					if (get_post_meta(get_the_ID(), "mkd_slide_text_content_top_margin", true) != "") {
                        $slide_content_style .= "margin-top: " . esc_attr(get_post_meta(get_the_ID(), "mkd_slide_text_content_top_margin", true)) . "px;";
                    }
					if (get_post_meta(get_the_ID(), "mkd_slide_text_content_bottom_margin", true) != "") {
                        $slide_content_style .= "margin-bottom: " . esc_attr(get_post_meta(get_the_ID(), "mkd_slide_text_content_bottom_margin", true)) . "px;";
                    }
					
					if (get_post_meta(get_the_ID(), "mkd_slide_text_content_box_shaddow", true) != "") {
                        $slide_content_style .= "box-shadow: " . esc_attr(get_post_meta(get_the_ID(), "mkd_slide_text_content_box_shaddow", true)) . ";";
                    }
					
					$slide_content_inner_shaddow="";
					if (get_post_meta(get_the_ID(), "mkd_slide_content_graphic_box_shaddow", true) != "") {
                        $slide_content_inner_shaddow .= "box-shadow: " . esc_attr(get_post_meta(get_the_ID(), "mkd_slide_content_graphic_box_shaddow", true)) . ";";
                    }
					
					$slide_content_inner_background="";
					if (get_post_meta(get_the_ID(), "mkd_slide_content_graphic_background", true) != "") {
                        $slide_content_inner_background .= "background-color: " . esc_attr(get_post_meta(get_the_ID(), "mkd_slide_content_graphic_background", true)) . ";";
                    }
					...
					$slide_graphic_style = "";
                    if (get_post_meta(get_the_ID(), "mkd_slide_graphic_background", true) != "") {
                        $slide_graphic_style .= "background-color: " . esc_attr(get_post_meta(get_the_ID(), "mkd_slide_graphic_background", true)) . ";";
                    }
					if (get_post_meta(get_the_ID(), "mkd_slide_graphic_top_padding", true) != "") {
                        $slide_graphic_style .= "padding-top: " . esc_attr(get_post_meta(get_the_ID(), "mkd_slide_graphic_top_padding", true)) . "px;";
                    }
					if (get_post_meta(get_the_ID(), "mkd_slide_graphic_bottom_padding", true) != "") {
                        $slide_graphic_style .= "padding-bottom: " . esc_attr(get_post_meta(get_the_ID(), "mkd_slide_graphic_bottom_padding", true)) . "px;";
                    }
                    $slide_title_style = "";
                    ...
                    if (get_post_meta(get_the_ID(), "mkd_slide-separator-title", true) == 'yes') {
                        ...
                        if (get_post_meta(get_the_ID(), "mkd_slide_title_separator_type", true) == "with_icon") {
                            ...
                            if (get_post_meta(get_the_ID(), "mkd_slide_title_separator_with_icon_icon_pack", true) != ''){
                                ...
                                $slide_separator_icon_param = $libero_mikado_IconCollections->getIconCollection($slide_separator_icon);
                    ...
                    if (get_post_meta(get_the_ID(), "mkd_slide_general_animation", true) === "no") {
                        $mkd_slide_general_animation_var = "no";
                    }
                    ...
                    if (get_post_meta(get_the_ID(), "mkd_slide_title_animation_scroll", true) == "yes") {
                        ...
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_title_start", true) != "") {
                            $slide_title_data_start = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_title_start", true));
                        }
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_title_start_custom_style", true) != "") {
                            $slide_title_data_start_custom_style = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_title_start_custom_style", true));
                        }
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_title_end", true) != "") {
                            $slide_title_data_end = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_title_end", true));
                        }
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_title_end_custom_style", true) != "") {
                            $slide_title_data_end_custom_style = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_title_end_custom_style", true));
                        }
                    ...
                    if (get_post_meta(get_the_ID(), "mkd_slide_subtitle_animation_scroll", true) == "yes") {
                        ...
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_subtitle_start", true) != "") {
                            $slide_subtitle_data_start = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_subtitle_start", true));
                        }
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_subtitle_start_custom_style", true) != "") {
                            $slide_subtitle_data_start_custom_style = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_subtitle_start_custom_style", true));
                        }
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_subtitle_end", true) != "") {
                            $slide_subtitle_data_end = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_subtitle_end", true));
                        }
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_subtitle_end_custom_style", true) != "") {
                            $slide_subtitle_data_end_custom_style = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_subtitle_end_custom_style", true));
                        }
                    ...
                    if (get_post_meta(get_the_ID(), "mkd_slide_graphic_animation_scroll", true) == "yes") {
                        ...
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_graphics_start", true) != "") {
                            $slide_graphics_data_start = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_graphics_start", true));
                        }
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_graphics_start_custom_style", true) != "") {
                            $slide_graphics_data_start_custom_style = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_graphics_start_custom_style", true));
                        }
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_graphics_end", true) != "") {
                            $slide_graphics_data_end = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_graphics_end", true));
                        }
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_graphics_end_custom_style", true) != "") {
                            $slide_graphics_data_end_custom_style = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_graphics_end_custom_style", true));
                        }
                    ...
                    if (get_post_meta(get_the_ID(), "mkd_slide_text_animation_scroll", true) == "yes") {
                        ...
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_text_start", true) != "") {
                            $slide_text_data_start = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_text_start", true));
                        }
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_text_start_custom_style", true) != "") {
                            $slide_text_data_start_custom_style = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_text_start_custom_style", true));
                        }
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_text_end", true) != "") {
                            $slide_text_data_end = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_text_end", true));
                        }
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_text_end_custom_style", true) != "") {
                            $slide_text_data_end_custom_style = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_text_end_custom_style", true));
                        }
                    ...
                    if (get_post_meta(get_the_ID(), "mkd_slide_button1_animation_scroll", true) == "yes") {
                        ...
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_button_1_start", true) != "") {
                            $slide_button_1_data_start = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_button_1_start", true));
                        }
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_button_1_start_custom_style", true) != "") {
                            $slide_button_1_data_start_custom_style = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_button_1_start_custom_style", true));
                        }
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_button_1_end", true) != "") {
                            $slide_button_1_data_end = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_button_1_end", true));
                        }
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_button_1_end_custom_style", true) != "") {
                            $slide_button_1_data_end_custom_style = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_button_1_end_custom_style", true));
                        }
                    ...
                    if (get_post_meta(get_the_ID(), "mkd_slide_button2_animation_scroll", true) == "yes") {
                        ...
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_button_2_start", true) != "") {
                            $slide_button_2_data_start = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_button_2_start", true));
                        }
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_button_2_start_custom_style", true) != "") {
                            $slide_button_2_data_start_custom_style = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_button_2_start_custom_style", true));
                        }
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_button_2_end", true) != "") {
                            $slide_button_2_data_end = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_button_2_end", true));
                        }
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_button_2_end_custom_style", true) != "") {
                            $slide_button_2_data_end_custom_style = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_button_2_end_custom_style", true));
                        }
                    ...
                    if (get_post_meta(get_the_ID(), "mkd_slide_separator_top_animation_scroll", true) == "yes") {
                        ...
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_separator_top_start", true) != "") {
                            $slide_separator_top_data_start = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_separator_top_start", true));
                        }
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_separator_top_start_custom_style", true) != "") {
                            $slide_separator_top_data_start_custom_style = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_separator_top_start_custom_style", true));
                        }
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_separator_top_end", true) != "") {
                            $slide_separator_top_data_end = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_separator_top_end", true));
                        }
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_separator_top_end_custom_style", true) != "") {
                            $slide_separator_top_data_end_custom_style = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_separator_top_end_custom_style", true));
                        }
                    ...
                    if (get_post_meta(get_the_ID(), "mkd_slide_separator_bottom_animation_scroll", true) == "yes") {
                        ...
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_separator_bottom_start", true) != "") {
                            $slide_separator_bottom_data_start = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_separator_bottom_start", true));
                        }
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_separator_bottom_start_custom_style", true) != "") {
                            $slide_separator_bottom_data_start_custom_style = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_separator_bottom_start_custom_style", true));
                        }
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_separator_bottom_end", true) != "") {
                            $slide_separator_bottom_data_end = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_separator_bottom_end", true));
                        }
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_separator_bottom_end_custom_style", true) != "") {
                            $slide_separator_bottom_data_end_custom_style = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_separator_bottom_end_custom_style", true));
                        }
                    ...
                    if (get_post_meta(get_the_ID(), "mkd_slide_svg_animation_scroll", true) == "yes") {
                        ...
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_svg_start", true) != "") {
                            $slide_svg_data_start = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_svg_start", true));
                        }
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_svg_start_custom_style", true) != "") {
                            $slide_svg_data_start_custom_style = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_svg_start_custom_style", true));
                        }
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_svg_end", true) != "") {
                            $slide_svg_data_end = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_svg_end", true));
                        }
                        if (get_post_meta(get_the_ID(), "mkd_slide_data_svg_end_custom_style", true) != "") {
                            $slide_svg_data_end_custom_style = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_data_svg_end_custom_style", true));
                        }
                    ...
                    $svg = '';
                    $svg_frame_rate = '';
                    if (get_post_meta(get_the_ID(), "mkd_slide_svg_source", true) != "") {
                        $svg = get_post_meta(get_the_ID(), "mkd_slide_svg_source", true);
                    }
                    $svg_drawing = "no";
                    if (get_post_meta(get_the_ID(), "mkd_slide_svg_drawing", true) == "yes") {
                        $svg_drawing = get_post_meta(get_the_ID(), "mkd_slide_svg_drawing", true);

                        $svg_frame_rate = '100';
                        if (get_post_meta(get_the_ID(), "mkd_slide_svg_frame_rate", true) !== "") {
                            $svg_frame_rate = esc_attr(get_post_meta(get_the_ID(), "mkd_slide_svg_frame_rate", true));
                        }
                    }
                    ...
                    if ($slide_type == 'video') {
                        ...
                        $html .= '<div class="video"><div class="mobile-video-image" '.libero_mikado_get_inline_style('background-image: url(' . esc_url($video_image) . ')').'></div><div class="video-overlay';
                        ...
                        $html .= '<div class="image" '.libero_mikado_get_inline_style('background-image:url(' . esc_url($image) . ')').'>';
                        if ($slider_thumbs == 'no') {
                            $html .= '<img src="' . esc_url($image) . '" alt="' . esc_attr($title) . '">';
                        }

                        if ($image_overlay_pattern !== "") {
                            $html .= '<div class="image_pattern" '.libero_mikado_get_inline_style('background: url(' . esc_url($image_overlay_pattern) . ') repeat 0 0').'></div>';
                        }
                        $html .= '</div>';
                    }
                    ...
                    if ( $svg != "" ) {
                        ...
                        $html_thumb .= '<div class="mkd_slide-svg-holder" data-svg-drawing="'.$svg_drawing.'" data-svg-frames="'.$svg_frame_rate.'">';
                    ...
                    if (get_post_meta(get_the_ID(), "mkd_slide-subtitle", true) != "") {
                        ...
                        $html_text .= '<h3 class="q_slide_subtitle" '.libero_mikado_get_inline_style($slide_subtitle_style).'><span '.libero_mikado_get_inline_style($slide_subtitle_span_style).'>' . wp_kses_post(get_post_meta(get_the_ID(), 'mkd_slide-subtitle', true)) . '</span></h3>';
                        $html_text .= '</div></div>';
                    }
                    ...
                    if ((get_post_meta(get_the_ID(), "mkd_slide-separator-title", true) == 'yes') && ($slide_separator_position != 'bottom' ) && ($slide_separator_position) != 'left_right') {
                        ...
                        if (get_post_meta(get_the_ID(), 'mkd_slide_title_separator_type', true) !== 'with_icon' && get_post_meta(get_the_ID(), 'mkd_slide_title_separator_type', true) !== 'with_custom_icon') {
                            ...
                            $html_text .= '<div '.libero_mikado_get_inline_style($slide_separator_styles.$slide_top_separator_styles).' class="separator separator_top"></div>';
                            $html_text .= '</div></div>';
                        }
                        else {
                            $html_text .= '<div class="el">';
                    ...
                    if (get_post_meta(get_the_ID(), "mkd_slide-hide-title", true) != true) {
                        ...
                        $html_text .= '<h2 class="q_slide_title" '.libero_mikado_get_inline_style($slide_title_style).'>';
                        if ($slide_separator_position == 'left_right') {
                            $html_text .= '<div '.libero_mikado_get_inline_style($slide_separator_styles.$slide_left_separator_margin).' class="separator separator_left"><span class="slide_separator_dots" '.libero_mikado_get_inline_style($slide_dots_style).'></span></div>';
                        }
                        if (get_post_meta(get_the_ID(), "mkd_slide-title-link", true) != '') {
                            $html_text .= '<a '.libero_mikado_get_inline_style($slide_title_style).' '.$slide_title_data.' href="' . esc_url(get_post_meta(get_the_ID(), "mkd_slide-title-link", true)) . '" target="' . esc_attr(get_post_meta(get_the_ID(), "mkd_slide-title-target", true)) . '">';
                        }
                        $html_text .= '<span '.libero_mikado_get_inline_style($slide_title_span_style).'>' . wp_kses_post(get_the_title()) . '</span>';
                        if (get_post_meta(get_the_ID(), "mkd_slide-title-link", true) != '') {
                            $html_text .= '</a>';
                        }
                        if ($slide_separator_position == 'left_right') {
                            $html_text .= '<div '.libero_mikado_get_inline_style($slide_separator_styles.$slide_right_separator_margin).' class="separator separator_right"><span class="slide_separator_dots" '.libero_mikado_get_inline_style($slide_dots_style).'></span></div>';
                        }
                    ...
                    if ((get_post_meta(get_the_ID(), "mkd_slide-separator-title", true) == 'yes') && ($slide_separator_position != 'top') && ($slide_separator_position) != 'left_right') {
                        ...
                        if (get_post_meta(get_the_ID(), 'mkd_slide_title_separator_type', true) !== 'with_icon' && get_post_meta(get_the_ID(), 'mkd_slide_title_separator_type', true) !== 'with_custom_icon') {
                            ...
                            $html_text .= '<div '.libero_mikado_get_inline_style($slide_separator_styles.$slide_bottom_separator_styles).'  class="separator separator_bottom"></div>';
                            $html_text .= '</div></div>';
                        }
                        else {
                            $html_text .= '<div class="el">';
                    ...
                    if (get_post_meta(get_the_ID(), "mkd_slide-text", true) != "") {
                        ...
                        if ($slide_text_separator_var == 'yes') {
                            ...
                            $html_text .= '<h3 class="q_slide_text" '.libero_mikado_get_inline_style($slide_text_style).'><span '.libero_mikado_get_inline_style($slide_text_span_style).'>' . wp_kses_post(get_post_meta(get_the_ID(), "mkd_slide-text", true)) . '</span></h3>';
                        }
                        $html_text .= '</div></div>';
                    }
                    ...
                    if (get_post_meta(get_the_ID(), "mkd_slide-button_background_hover_color", true) != "" && get_post_meta(get_the_ID(), "mkd_slide-button1_hover_button_animation", true) == '' ) {
                        $data_attr1 .= "data-hover-background-color=" . esc_attr(get_post_meta(get_the_ID(), "mkd_slide-button_background_hover_color", true)) . " ";
                    }
					if (get_post_meta(get_the_ID(), "mkd_slide-button_background_hover_color", true) != "" && get_post_meta(get_the_ID(), "mkd_slide-button1_hover_button_animation", true) !== '' ) {
                        $data_attr1 .= "data-hover-animated-background-color=" . esc_attr(get_post_meta(get_the_ID(), "mkd_slide-button_background_hover_color", true)) . " ";
                    }
                    ...
                    if ($is_first_button_shown) {
                        ...
                        if(get_post_meta(get_the_ID(), 'button1_icon_pack', true) !== 'no_icon') {
                            $first_btn_icon_collection = $libero_mikado_IconCollections->getIconCollection(get_post_meta(get_the_ID(), 'button1_icon_pack', true));
						...
						$span='';
						$first_button_class='';
						if(get_post_meta(get_the_ID(), "mkd_slide-button1_hover_button_animation", true) !== '') {
                            $first_button_class = esc_attr(get_post_meta(get_the_ID(), "mkd_slide-button1_hover_button_animation", true));
							$span='<span class="a_overlay"></span>';
                        }
						
                        $html_text .= '<a class="qbutton '.esc_attr($first_button_icon_class) . esc_attr($first_button_class).'" ' . $data_attr1 . ' '.libero_mikado_get_inline_style($button_text_style1).' '.$slide_button_1_data.' href="' . esc_url(get_post_meta(get_the_ID(), "mkd_slide-button-link", true)) . '" target="' . esc_attr($slide_button_target) . '"><span class="text_wrap">' . esc_html(get_post_meta(get_the_ID(), "mkd_slide-button-label", true)) . '</span>' . $first_button_icon_html . $span .'</a>';
                    }
                    ...
                    if (get_post_meta(get_the_ID(), "mkd_slide-button_background_hover_color2", true) != "" && get_post_meta(get_the_ID(), "mkd_slide-button2_hover_button_animation", true) == '') {
                        $data_attr2 .= "data-hover-background-color=" . esc_attr(get_post_meta(get_the_ID(), "mkd_slide-button_background_hover_color2", true)) . " ";
                    }
					if (get_post_meta(get_the_ID(), "mkd_slide-button_background_hover_color2", true) != "" && get_post_meta(get_the_ID(), "mkd_slide-button2_hover_button_animation", true) !== '' ) {
                        $data_attr2 .= "data-hover-animated-background-color=" . esc_attr(get_post_meta(get_the_ID(), "mkd_slide-button_background_hover_color2", true)) . " ";
                    }
                    ...
                    if ($is_second_button_shown) {
                        ...
                        if(get_post_meta(get_the_ID(), 'button2_icon_pack', true) !== 'no_icon') {
                            $second_btn_icon_collection = $libero_mikado_IconCollections->getIconCollection(get_post_meta(get_the_ID(), 'button2_icon_pack', true));
						...
						$span2='';
						$second_button_class='';
						if(get_post_meta(get_the_ID(), "mkd_slide-button2_hover_button_animation", true) !== '') {
                            $second_button_class = esc_attr(get_post_meta(get_the_ID(), "mkd_slide-button2_hover_button_animation", true));
							$span2='<span class="a_overlay"></span>';
                        }
						
                        $html_text .= '<a class="qbutton '.esc_attr($second_button_icon_class) . esc_attr($second_button_class). '" ' . $data_attr2 . ' '.libero_mikado_get_inline_style($button_text_style2).' '.$slide_button_2_data.' href="' . esc_url(get_post_meta(get_the_ID(), "mkd_slide-button-link2", true)) . '" target="' . esc_attr($slide_button_target2) . '"><span class="text_wrap">' . esc_html(get_post_meta(get_the_ID(), "mkd_slide-button-label2", true)) . '</span>' . $second_button_icon_html . $span2 .  '</a>';
                    }
                    ...
                    if ($separate_text_graphic != 'yes') {
                        $html .= '<div class="slider_content ' . esc_attr($content_alignment) .'" '.libero_mikado_get_inline_style($content_width . $content_xaxis . $content_yaxis_start).' '.$slide_data_start.' '.$slide_data_end.' '.$slide_data_content_resize.'>';
							if(get_post_meta(get_the_ID(), "mkd_slide-content-vertical-middle", true) == "yes"){
								$html .= '<div class="slider_content_inner ' . esc_attr($content_animation . ' ' . $content_animation_direction) .'" '.libero_mikado_get_inline_style($vertical_content_width . $vertical_content_xaxis . $slide_content_inner_shaddow . $slide_content_inner_background).'>';
							}
							$html .= $html_thumb;
							$html .= $html_text;
							if(get_post_meta(get_the_ID(), "mkd_slide-content-vertical-middle", true) == "yes"){
                        ...
                        $html .= '<div class="slider_content graphic_content ' . esc_attr($graphic_alignment) . '" '.libero_mikado_get_inline_style($graphic_width . $graphic_xaxis . $graphic_yaxis_start).'>';
							if(get_post_meta(get_the_ID(), "mkd_slide-content-vertical-middle", true) == "yes"){
								$html .= '<div class="slider_content_inner" '.libero_mikado_get_inline_style($vertical_content_width . $vertical_content_xaxis . $slide_content_inner_shaddow . $slide_content_inner_background).'>';
							}
							$html .= $html_thumb;
							if(get_post_meta(get_the_ID(), "mkd_slide-content-vertical-middle", true) == "yes"){
								$html .= '</div>';
                ...
                $html .= __('Sorry, no slides matched your criteria.', 'mikado_core');
            endif;
            wp_reset_query();
            ...
            if ($found_slides > 1) {
                if ($show_navigation_circles == "yes") {
                    ...
                    $triangle_bkg='';
                    if(isset($libero_mikado_options['enable_slider_triangle']) && $libero_mikado_options['enable_slider_triangle'] == 'yes') {
                ...
                if ($show_navigation_arrows == "yes") {
                    ...
                    if (isset($libero_mikado_options['navigation_arrows_type']) && $libero_mikado_options['navigation_arrows_type'] != '') {
                        $icon_navigation_class = $libero_mikado_options['navigation_arrows_type'];
                    }
