=== WP Doctor ===
Contributors: http://www.bestiaweb.com
Donate link: http://www.bestiaweb.com
Tags: doctor, malware, antivirus, malware cleaner, antimalware, anti malware, malware scan, malware scanner, security, protection, virus, security, protection, permissions, htaccess, ip block, blacklist
...
WP Doctor is based on [security guidelines wordpress](http://codex.wordpress.org/Hardening_WordPress). For more information visit [WP DOCTOR PLUGIN PAGE](http://www.bestiaweb.com/wpdoctor) and [our website](http://www.bestiaweb.com).
