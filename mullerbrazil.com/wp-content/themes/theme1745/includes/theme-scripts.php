...
function my_script() {
	if (!is_admin()) {
		...
		wp_enqueue_script('prettyPhoto', get_bloginfo('template_url').'/js/jquery.prettyPhoto.js', array('jquery'), '3.1.4');
		wp_enqueue_script('prettySociable', get_bloginfo('template_url').'/js/jquery.prettySociable.js', array('jquery'), '1.2.1');
		...
		wp_enqueue_script('hoverIntent', get_bloginfo('template_url').'/js/hoverIntent.js', array('jquery'), '1.0');
	}
}
