...
class MY_PopularPostsWidget extends WP_Widget {
              ...
              <ul class="popular-posts">
                  ...
                  $pop_posts = $count;
                    ...
                    if($posts){
					 ...
					 <?php } ?>
                          <a href="<?php echo $guid; ?>"><?php _e('Read more &gt;&gt;','theme1745');?></a>
                        </li>
                    <?php
                        }
                    }
    ...
    ?>
      ...
      <p><label for="<?php echo $this->get_field_id('count'); ?>"><?php _e('Posts per page:', 'theme1745'); ?><input class="widefat" style="width:30px; display:block; text-align:center" id="<?php echo $this->get_field_id('count'); ?>" name="<?php echo $this->get_field_name('count'); ?>" type="text" value="<?php echo $count; ?>" /></label></p>
